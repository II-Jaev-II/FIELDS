...
@if ($waterProfile)
    ...
    <div class="col-md-8">
        ...
        <div class="form-group d-inline-block ml-2 col-md-2">
            <input class="form-control" type="text" name="openSourceHectares" id="open-source-text"
                autocomplete="off" value="{{ old('openSourceHectares', optional($waterProfile)->PISOSHectares) }}"
                readonly>
        </div>
    </div>
    ...
    <div class="col-md-8">
        ...
        <div class="form-group d-inline-block ml-2 col-md-2">
            <input class="form-control" type="text" name="diversionHectares" id="diversion-text"
                autocomplete="off" value="{{ old('diversionHectares', optional($waterProfile)->DDHectares) }}"
                readonly>
        </div>
    </div>
    ...
    <div class="col-md-8">
        ...
        <div class="form-group d-inline-block ml-2 col-md-2">
            <input class="form-control" type="text" name="checkDamHectares" id="check-dam-text"
                autocomplete="off" value="{{ old('checkDamHectares', optional($waterProfile)->CDHectares) }}"
                readonly>
        </div>
    </div>
    ...
    <div class="col-md-8 mt-2">
        ...
        <div class="form-group d-inline-block ml-2 col-md-2">
            <input class="form-control" type="text" name="rainfallHectares" id="rainfall-text"
                autocomplete="off" value="{{ old('rainfallHectares', optional($waterProfile)->rainfallHectares) }}"
                readonly>
        </div>
    </div>
    <div class="mt-3">
...
@else
    ...
    <div x-data="{ facilityHectares: {} }">
                    ...
                    <div x-show="open">
                        <div class="form-group d-inline-block ml-2 col-md-2">
                            <input x-model.number="facilityHectares['{{ $key }}']"
                                ...
                                type="text" name="{{ strtolower($key) . 'Hectares' }}" id="{{ $key . '-text' }}"
                                placeholder="Hectares" autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-3">
            <label for="grandTotal" class="form-label label-style">Grand Total of Hectares</label>
            <input :value="Object.values(facilityHectares).reduce((total, value) => total + (value || 0), 0)"
                type="text" class="form-control" name="grandTotalHectares" id="grandTotal" style="width: 70px;"
                readonly>
        </div>
    </div>
@endif
