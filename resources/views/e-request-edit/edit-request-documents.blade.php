<div class="col-md-3 mb-2">
    <label for="natureOfRequest" class="form-label label-style">Nature of Request</label>
    <input type="text" class="form-control" name="natureOfRequest" id="natureOfRequest"
        value="{{ $ERequest->natureOfRequest }}" readonly>
</div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-6">
            <label for="animalEndorsementLetter2" class="form-label label-style">Endorsement Letter from
                MAFC/CAFC</label>
            <input type="file" class="form-control" name="animalEndorsementLetter2" id="animalEndorsementLetter2">
            <div>
    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <label for="productionManagementPlan" class="form-label label-style">Production Management
                Plan</label>
            <input type="file" class="form-control" name="productionManagementPlan" id="productionManagementPlan">
            <div>
...
@else
    <input type="text" name="province" id="province" value="{{ $associationProfile->province_name }}" hidden
        readonly>
    <div class="row mb-2">
        <div class="col-md-6">
            <label for="letterIntent" class="form-label label-style">Letter of Intent</label>
